...
public final class SumServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<sum.SumOuterClass.SumRequest,
      sum.SumOuterClass.SumResponse> getDoSumMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "DoSum",
      requestType = sum.SumOuterClass.SumRequest.class,
      responseType = sum.SumOuterClass.SumResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<sum.SumOuterClass.SumRequest,
      sum.SumOuterClass.SumResponse> getDoSumMethod() {
    io.grpc.MethodDescriptor<sum.SumOuterClass.SumRequest, sum.SumOuterClass.SumResponse> getDoSumMethod;
    if ((getDoSumMethod = SumServiceGrpc.getDoSumMethod) == null) {
      synchronized (SumServiceGrpc.class) {
        if ((getDoSumMethod = SumServiceGrpc.getDoSumMethod) == null) {
          SumServiceGrpc.getDoSumMethod = getDoSumMethod =
              io.grpc.MethodDescriptor.<sum.SumOuterClass.SumRequest, sum.SumOuterClass.SumResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "DoSum"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sum.SumOuterClass.SumRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sum.SumOuterClass.SumResponse.getDefaultInstance()))
              .setSchemaDescriptor(new SumServiceMethodDescriptorSupplier("DoSum"))
              .build();
        }
      }
    }
  ...
  public static abstract class SumServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void doSum(sum.SumOuterClass.SumRequest request,
        io.grpc.stub.StreamObserver<sum.SumOuterClass.SumResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                sum.SumOuterClass.SumRequest,
                sum.SumOuterClass.SumResponse>(
  ...
  public static final class SumServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<SumServiceBlockingStub> {
    ...
    /**
     */
    public sum.SumOuterClass.SumResponse doSum(sum.SumOuterClass.SumRequest request) {
  ...
  public static final class SumServiceFutureStub extends io.grpc.stub.AbstractFutureStub<SumServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<sum.SumOuterClass.SumResponse> doSum(
        sum.SumOuterClass.SumRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_DO_SUM:
          serviceImpl.doSum((sum.SumOuterClass.SumRequest) request,
              (io.grpc.stub.StreamObserver<sum.SumOuterClass.SumResponse>) responseObserver);
          break;
        default:
